...
export class migrationGabrielDbTeste1667335799698 implements MigrationInterface {
    name = 'migrationGabrielDbTeste1667335799698'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "enderecos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "logradouro" character varying(120) NOT NULL, "numero" integer, "bairro" character varying(50) NOT NULL, "complemento" character varying(50), "cidade" character varying(50) NOT NULL, "estado" character varying(2) NOT NULL, "cep" character varying(10) NOT NULL, CONSTRAINT "PK_208b05002dcdf7bfbad378dcac1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "veiculos_multas" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "data" date NOT NULL, "ativo" boolean NOT NULL DEFAULT true, "multaId" uuid, "veiculoId" uuid, CONSTRAINT "PK_7324c33009c89ef016ee4d71ba0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "veiculos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "placa" character varying(8) NOT NULL, "cor" character varying(50) NOT NULL, "modelo" character varying(50) NOT NULL, "marca" character varying(50) NOT NULL, "ano" date NOT NULL, "chassi" character varying(17) NOT NULL, "cidadaoId" uuid, CONSTRAINT "PK_0c3daa1e5d16914bd9e7777cf77" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cidadaos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nome" character varying(120) NOT NULL, "idade" integer NOT NULL, "email" character varying(120) NOT NULL, "cpf" character varying(14) NOT NULL, "data_nascimento" date NOT NULL, "enderecoId" uuid, CONSTRAINT "UQ_68f3b7bbe4e72a108dcc97f22b8" UNIQUE ("email"), CONSTRAINT "UQ_b0e9037216d7369e60994f50689" UNIQUE ("cpf"), CONSTRAINT "REL_54d851f50f3f4230fd536af1be" UNIQUE ("enderecoId"), CONSTRAINT "PK_3ff2042dc6d2630da8c0def51df" PRIMARY KEY ("id"))`);
